                        ...
                        <section class="mb-0 mt-0">
                            <div role="menu" class="collapsed" data-bs-toggle="collapse" data-bs-target="#iconAccordionOne" aria-expanded="false" aria-controls="iconAccordionOne">
                                <div class="accordion-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-filter"><polygon points="22 3 2 3 10 12.46 10 19 14 21 14 12.46 22 3"></polygon></svg>                                    Filtro
                                    <div class="icons">
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            ...
                                            <input name="inputIdade" id="inputIdade" class="form-control flatpickr flatpickr-input active" type="number" placeholder="Idade...">
                                        </div>
                                        <div class="col-md-4">
